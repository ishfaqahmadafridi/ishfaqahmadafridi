...
import type { WomenFootwearCardProps } from '../interfaces/womenfoot/womenfootInterface';

export default function WomenFootwearCard({ category }: WomenFootwearCardProps) {

import type { FragranceProductImageProps } from '../interfaces/catfragrance/catfragranceInterface';

export default function FragranceProductImage({ src, name, discount }: FragranceProductImageProps) {
    return (

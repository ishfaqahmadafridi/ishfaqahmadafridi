import type { SkincareAddToCartBtnProps } from '../interfaces/catskincare/catskincareInterface';

export default function SkincareAddToCartBtn({ onClick }: SkincareAddToCartBtnProps) {
    return (
        <button
            onClick={onClick}

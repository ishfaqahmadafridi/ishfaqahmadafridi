...
import { setPage, setSelectedCategories } from '../redux/slices/uiSlice/uiSlice';
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto">
        {categories.map((cat, i) => (
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-purple-900/90 via-transparent to-transparent flex items-end p-8">

...
import { updateProfile, changePassword, uploadProfileImage } from './profileThunk';
    ...
    extraReducers: (builder) => {
        builder
            ...
            .addCase(uploadProfileImage.fulfilled, (state, action) => {
                ...
                state.profileData.profileImage = action.payload.image_url || localStorage.getItem('profile_image');
            })
...
export const { clearUpdateMessage, clearPasswordMessage, updateLocalProfile, removeProfileImage } = profileSlice.actions;

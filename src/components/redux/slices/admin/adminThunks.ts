...
export const fetchDashboardStats = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(error || 'Failed to fetch dashboard stats');
    }
  }
);
...
export const updateProductStock = createAsyncThunk(
  ...
  async ({ id, stock }, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(error || 'Failed to update stock');
    }
  }
);
...
export const fetchInventoryStatus = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(error || 'Failed to fetch inventory status');
    }
  }
);
...
export const fetchLowStockProducts = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(error || 'Failed to fetch low stock products');
    }
  }
);
...
export const fetchOutOfStockProducts = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(error || 'Failed to fetch out of stock products');
    }
  }
);
...
export const fetchRecentOrders = createAsyncThunk(
  ...
  async (days = 7, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(error || 'Failed to fetch recent orders');
    }
  }
);
...
export const fetchSalesAnalytics = createAsyncThunk(
  ...
  async (period = 'week', { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(error || 'Failed to fetch sales analytics');
    }
  }
);
...
export const fetchUserAnalytics = createAsyncThunk(
  ...
  async (period = 'week', { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(error || 'Failed to fetch user analytics');
    }
  }
);
...
export const fetchTopSellingProducts = createAsyncThunk(
  ...
  async (limit = 10, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(error || 'Failed to fetch top products');
    }
  }
);
...
export const logUserActivity = createAsyncThunk(
  ...
  async ({ activity_type, metadata }, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(error || 'Failed to log activity');
    }
  }
);

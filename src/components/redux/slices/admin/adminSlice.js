...
export const selectLowStockProducts = (state) => state.admin.lowStockProducts;
export const selectOutOfStockProducts = (state) => state.admin.outOfStockProducts;
...
export const selectTopProducts = (state) => state.admin.topProducts;

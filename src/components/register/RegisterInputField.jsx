    ...
    <div className="space-y-2">
      ...
      <div className="relative group">
        ...
        <input
          ...
          onChange={onChange}
          className="w-full pl-12 pr-4 py-4 bg-gray-50 border-2 border-gray-300 focus:border-purple-500 focus:ring-2 focus:ring-purple-200 focus:bg-white rounded-xl outline-none transition-all font-medium text-gray-900 placeholder:text-gray-400"
          required={required}
        />
      </div>
    </div>

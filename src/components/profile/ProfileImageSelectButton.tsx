...
import type { ProfileImageSelectButtonProps } from '../interfaces/profile/profileInterface';

export default function ProfileImageSelectButton({ onSelect }: ProfileImageSelectButtonProps) {
    return (

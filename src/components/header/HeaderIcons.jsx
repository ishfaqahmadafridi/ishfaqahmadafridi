...
import { toggleTheme, selectTheme, setPage, toggleSearchDialog } from '../redux/slices/uiSlice/uiSlice';
...
export default function HeaderIcons() {
    ...
    return (
        <div className="flex items-center gap-4 md:gap-6 text-xl">
            ...
            <button onClick={() => dispatch(setPage('cart'))} className="relative p-2 hover:opacity-50 transition-opacity">
                <IoCartOutline />
            ...
            {isAuthenticated ? (
                <>
                    <button onClick={() => dispatch(setPage('profile'))} className="p-2 hover:text-purple-600 transition-colors">
                        <IoPersonOutline />
                    </button>
                ...
                <button onClick={() => dispatch(setPage('signin'))} className="p-2 hover:opacity-50 transition-opacity">
                    <IoPersonOutline />
                </button>
            )}
        </div>
